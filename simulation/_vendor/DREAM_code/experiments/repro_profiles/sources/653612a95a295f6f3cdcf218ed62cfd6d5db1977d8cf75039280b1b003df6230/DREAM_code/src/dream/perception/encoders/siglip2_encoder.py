...
class Siglip2Encoder(BaseImageTextEncoder):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        load_plan = build_hf_load_plan(model_name, "SIGLIP2")
        ...
        if load_plan.local_snapshot is not None:
            print(f"Loaded siglip2 model from local cache: {load_plan.local_snapshot}")
        else:
            print(f"Loaded siglip2 model from {model_name}")
