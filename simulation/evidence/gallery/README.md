...
`python -m simulation.run --case 01` (substitute the desired ID).
...
From the DREAM repository root, `python -m simulation.verify_evidence` checks
...
`../../README.md`. Fresh ten-profile delivery execution evidence is separately
