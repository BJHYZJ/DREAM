...
def main():
    ...
    if args.cohort_id:
        ...
        if (args.benchmark or len(task_data) != 50 or len({t["scene"] for t in task_data}) != 50
                ...
                or any(t["maximum_sim_seconds"] != 1200 for t in task_data)):
            raise ValueError("Residential cohort requires 50 distinct houses, seed 42, dynamic memory and 10 tasks per recipe")
