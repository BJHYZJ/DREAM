...
def main():
    ...
    def audit(record):
        ...
        try:
            ...
            report["strict_checks_passed"]=bool(review["record_review_passed"])
            report["automatic_checks_passed"]=bool(review["primary_task_record_review_passed"] if args.all_task_successes else review["record_review_passed"])
