...
def _ensure_path_exists() -> None:
    """Ensure that the ~/.dream directory exists."""
...
def lookup_address(
    ...
    """Return the address of the robot. Will also create and update ~/.dream/robot_ip.txt file to manage robot IP address.
...
def get_path_to_map(name: str) -> str:
    """Gets a map filename in the .dream store directory"""
    _ensure_path_exists()
...
def get_path_to_image(name: str) -> str:
    """Gets an image filename in the .dream store directory"""
    _ensure_path_exists()
...
def get_path_to_debug(name: str) -> str:
    """Gets a debug filename in the .dream store directory"""
    _ensure_path_exists()
