...
import dream.app.dex_teleop.dex_teleop_parameters as dt
import dream.app.dex_teleop.dex_teleop_utils as dt_utils
import dream.app.dex_teleop.goal_from_teleop as gt
import dream.app.dex_teleop.webcam_teleop_interface as wt
import dream.motion.simple_ik as si
import dream.utils.compression as compression
import dream.utils.logger as logger
from dream.core import Evaluator
from dream.core.client import RobotClient
from dream.motion.pinocchio_ik_solver import PinocchioIKSolver
from dream.utils.data_tools.record import FileDataRecorder
    ...
    def get_goal_joint_config(
        ...
        **config,
        ...
        if new_goal_configuration is None:
            ...
            # TODO
            # Following line used by simple_IK, but can only be run on dream due to need for robot status.
