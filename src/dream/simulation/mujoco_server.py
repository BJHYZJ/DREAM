...
try:
    from dream.simulation.robocasa_gen import load_model_from_xml, model_generation_wizard
except ImportError as e:
    from dream.utils.logger import error
...
import dream.simulation.utils as sim_utils
...
from dream.utils.geometry import pose_global_to_base, xyt_base_to_global, xyt_global_to_base
from dream.utils.image import scale_camera_matrix
...
class MujocoZmqServer(BaseZmqServer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # They should probably stay in dream mujoco
...
@click.option(
    "--scene_path", default=None, help="Provide a path to mujoco scene file with dream.xml"
)
@click.option(
    "--use-robocasa",
    "--use_robocasa",
