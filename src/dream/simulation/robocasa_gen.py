...
from dream.utils.geometry import xyt_base_to_global
...
def model_generation_wizard(
    ...
    print("Placing dream at", robot_base_fixture_pose)
    # Quaternion to theta
...
def add_stretch_to_kitchen(xml: str, robot_pose_attrib: dict) -> str:
    """
    Add dream robot to kitchen xml
    """
    print(
        f"Adding dream to kitchen at pos: {robot_pose_attrib['pos']} quat: {robot_pose_attrib['quat']}"
    )
