...
from dream.utils.point_cloud import create_visualization_geometries, numpy_to_pcd, points_in_mesh
...
class SparseVoxelMap(object):
    ...
    def write_to_pickle(self, filename: str, compress: bool = True) -> None:
        ...
        logger.alert()
        logger.alert(f"\tpython -m dream.app.read_map -i {filename} --show-svm")
        logger.alert()
