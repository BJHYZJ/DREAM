...
from dream.agent.task.dynamem import DynamemTaskExecutor
from dream.agent.task.pickup import PickupExecutor
from dream.llms import PickupPromptBuilder, get_llm_client
from dream.utils.discord_bot import DiscordBot, Task
...
class StretchDiscordBot(DiscordBot):
    """Simple dream discord bot. Connects to Discord via the API."""
    ...
    def __init__(
        ...
        home_channel: str = "talk-to-dream",
    ) -> None:
        """
