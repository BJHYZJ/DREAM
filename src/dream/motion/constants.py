...
MANIP_STRETCH_URDF = get_full_config_path("urdf/dream.urdf")
...
look_left_1 = [30, -45, -90, 0, 110, 0]
look_left_2 = [30, -45, -90, 30, 110, 0]
look_right_1 = [-30, -45, -90, 0, 110, 0]
look_right_2 = [-30, -45, -90, -30, 110, 0]
