...
def main():
    ...
    helper = {"assets": "prepare_instruction_assets.py", "models": "prepare_learned_models.py"}[
        args.resource
    ]
    ...
    raise SystemExit(
        subprocess.call([sys.executable, str(engine_root() / "experiments" / helper), *forwarded])
    )
